...
export FSLDIR=/opt/local/fsl-5.0.6/fsl
. ${FSLDIR}/etc/fslconf/fsl.sh
...
export HCPPIPEDIR=/home/range1-raid1/kjamison/Source/Pipelines
#export CARET7DIR=${HOME}/workbench/bin_linux64
#export CARET7DIR=/opt/local/hcp-workbench-1.0/workbench/bin_rh_linux64
export CARET7DIR=/home/range1-raid1/kjamison/workbench_dev/bin_rh_linux64
