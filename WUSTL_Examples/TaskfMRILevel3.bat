  ...
  for Parcellation in $ParcellationList ; do
    ...
    for LevelTwofMRIName in $LevelTwoTaskList ; do
      ...
      for FinalSmoothingFWHM in $SmoothingList ; do
        fsl_sub -q veryshort.q ${HCPPIPEDIR}/TaskfMRIAnalysis/TaskfMRILevel3.sh ${Subjlist} ${StudyFolder} ${CommonFolder} ${GroupAverageName} ${LevelThreeDesignTemplate} ${LevelTwofMRIName} ${LevelTwofsfName} ${LowResMesh} ${FinalSmoothingFWHM} ${TemporalFilter} ${VolumeBasedProcessing} ${RegName} ${Parcellation}
        echo "set -- ${Subjlist} ${StudyFolder} ${CommonFolder} ${GroupAverageName} ${LevelThreeDesignTemplate} ${LevelTwofMRIName} ${LevelTwofsfName} ${LowResMesh} ${FinalSmoothingFWHM} ${TemporalFilter} ${VolumeBasedProcessing} ${RegName} ${Parcellation}" 
      done
      i=$(($i+1))
    done
  done
