...
for Subject in $Subject_all; do
	...
	UnwarpAxis=y
        ...
        ############### Volume Pipeline Options ########################
            ...
            GradientDistortionCoeffs="/home/range1-raid1/kjamison/hcp_pipeline/grad_coeffs/7TAS_coeff_SC72CD.grad" #Gradient distortion correction coefficents, set to NONE to turn off
