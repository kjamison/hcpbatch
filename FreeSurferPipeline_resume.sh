...
#autorecon2 = recon-all -subjid $SubjectID -sd $SubjectDIR (otherstuff+) -tessellate -smooth1 -inflate1 -qsphere -fix -white -smooth2 -inflate2
recon-all -subjid $SubjectID -sd $SubjectDIR -tessellate -smooth1 -inflate1 -qsphere -fix -white -nocurvstats -nosegstats -openmp 8
