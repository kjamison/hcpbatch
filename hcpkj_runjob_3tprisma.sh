...
for Subject in $Subject_all; do
	...
	UnwarpAxis=y
        ...
        ############### Volume Pipeline Options ########################
            ...
            GradientDistortionCoeffs="/home/range1-raid1/kjamison/Data/Pipelines/global/config/coeff_CMRR_Prisma.grad" #Gradient distortion correction coefficents, set to NONE to turn off
