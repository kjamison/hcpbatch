...
#FSLDIR=/opt/local/fsl-5.0.7/fsl
FSLDIR=/opt/local/fsl-5.0.6/fsl
. ${FSLDIR}/etc/fslconf/fsl.sh

# Set up FreeSurfer (if not already done so in the running environment)
#FREESURFER_HOME=/usr/local/bin/freesurfer
#FREESURFER_HOME=/opt/local/freesurfer-5.3/x86_64
...
export HCPPIPEDIR=/home/range1-raid1/kjamison/Data/Pipelines
export PATH=$PATH:${HCPPIPEDIR}/src/gradient_unwarping/build/scripts.linux-x86_64-2.7
