...
echo " "
echo " START: MotionCorrection_MCFLIRTBased"
...
${HCPPIPEDIR_Global}/mcflirt_basic.sh ${InputfMRI} ${WorkingDirectory}/${OutputfMRIBasename} ${Scout}
...
echo "   END: MotionCorrection_MCFLIRTBased"
